...
cuisines = [('african', 'African'), ('american', 'American'), ('british', 'British'), ('cajun', 'Cajun'), ('carribean', 'Carribean'), ('chinese', 'Chinese'), ('eastern european', 'Eastern European'), ('european', 'European'), ('french', 'French'), ('german', 'German'), ('greek', 'Greek'), ('indian', 'Indian'), ('irish', 'Irish'),
...
diets = [('ketogenic', 'Ketogenic'), ('lacto-vegetarian', 'Lacto-Vegetarian'), ('ovo-vegetarian', 'Ovo-Vegetarian'),
         ('pescetarian', 'Pescetarian'), ('paleo', 'Paleo'), ('primal', 'Primal'), ('lowFodmap', 'Low FODMAP'), ('whole30', 'Whole30')]
